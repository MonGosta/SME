				...
				<form method="post" role="form" id="login" class="login-form fade-in-effect">
					...
					<div class="login-header">
						<a href="dashboard-1.html" class="logo">
							<img src="assets/images/logoCasfid2.png" alt="" width="80" />
						</a>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control input-dark" name="email" id="email" autocomplete="off" value=" <?=$user->getEmail(); ?>"/>
					</div>
	
					<div class="form-group">
						<label class="control-label" for="contrasena">Contraseña</label>
						<input type="password" class="form-control input-dark" name="contrasena" id="contrasena" autocomplete="off" value="<?=$user->getContrasena(); ?>"/>
					</div>
